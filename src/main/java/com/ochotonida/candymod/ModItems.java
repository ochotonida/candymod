...
public final class ModItems {
    ...
    public static final ModFoodItem WAFER_STICK = new ModFoodItem("wafer_stick", 5, 0.6F, "foodWaferstick");
    ...
    public static final ItemChocolate CHOCOLATE_BAR = new ItemChocolate("chocolate_bar", "foodChocolatebar");
